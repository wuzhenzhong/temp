...
![img](https://user-gold-cdn.xitu.io/2019/10/22/16df1137a15df8d4?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/21/16debf7c76553b3b?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
1. 我们通过getters来创建状态：通过this.$store.getters来调用

可以根据某一个状态派生出一个新状态，vuex也提供了mapGetters辅助函数来帮助我们在组件中使用getters里的状态。

1. 使用mutations来更改state：通过this.$store.commit来调用
...
![img](https://user-gold-cdn.xitu.io/2019/10/21/16debf86d5319f37?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/21/16debf90bf4c9fc2?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)



## 彩蛋

以上为本期介绍，您可以关注我的公众号前端之阶，关注更多前端知识，获取前端大群，里面很多知名互联网前端朋友，前端技术更新太快，不能被落伍淘汰，共同学习，共同进步！