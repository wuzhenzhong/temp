...
- [本地化](https://www.52abp.com/Wiki/abp-cn/latest/6.3ABP表现层-本地化)
- [导航](https://www.52abp.com/Wiki/abp-cn/latest/6.4ABP表现层-导航栏)
...
最后，我们通过创建一个扩展的方法IModuleConfigurations来得到配置的引用。如下代码： ![img](https://raw.githubusercontent.com/52ABP/ABPCNDocs/V3.7.4/src/Wiki_abp_images/1.4.1.png)
