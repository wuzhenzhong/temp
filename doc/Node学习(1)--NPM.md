...
0.5662018.03.22 16:16:37字数 5578阅读 1107

## 简介

`npm`有两层含义。一层含义是Node的开放式模块登记和管理系统，网址为[npmjs.org](https://link.jianshu.com/?t=http%3A%2F%2Fnpmjs.org%2F)。另一层含义是Node默认的模块管理器，是一个命令行下的软件，用来安装和管理Node模块。
...
上面命令启动服务，用的是[live-server](https://link.jianshu.com/?t=http%3A%2F%2Fnpmjs.com%2Fpackage%2Flive-server)模块，将服务启动在9090端口，展示`dist`子目录。
...
以上都是npm相关操作的钩子，如果安装某些模块，还能支持Git相关的钩子。下面以[husky](https://link.jianshu.com/?t=https%3A%2F%2Fgithub.com%2Ftypicode%2Fhusky)模块为例。
