...
![数字的连续范围](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
...
![统计每天的每小时用户签到情况](https://lc-gold-cdn.xitu.io/6da3124379b8a303b97a.png?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![统计每天的每小时用户签到情况(当某个小时没有数据时，显示0)](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
...
![统计每天的用户签到数据和每天的增量数据](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
...
![统计签到天数相同的用户数量](https://lc-gold-cdn.xitu.io/73acc76585b6d838d5f5.png?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![统计每个用户的连续签到时间](https://lc-gold-cdn.xitu.io/c795d8540c7f9d0674ae.png?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
