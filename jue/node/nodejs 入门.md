...
![img](https://lc-api-gold-cdn.xitu.io/be4904981599c08956d8.gif?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
浏览器访问 [http://127.0.0.1:8888/，输出结果如下：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8888%2F，输出结果如下：)
...
更多详情可以访问 [nodejs.org/api/util.ht…](https://link.juejin.im/?target=http%3A%2F%2Fnodejs.org%2Fapi%2Futil.html) 了解详细内容。
...
更多内容，请查看官网文件模块描述：[File System](https://link.juejin.im/?target=https%3A%2F%2Fnodejs.org%2Fapi%2Ffs.htmlfs_fs_rename_oldpath_newpath_callback)。
...
在浏览器中访问[http://localhost:3000/user?name=w3c&email=w3c@w3cschool.cc](https://link.juejin.im/?target=http%3A%2F%2Flocalhost%3A3000%2Fuser%3Fname%3Dw3c%26email%3Dw3c%40w3cschool.cc) 然后查看返回结果:
...
| 模块名                                                       | 描述                                                      |
| ------------------------------------------------------------ | --------------------------------------------------------- |
| [OS 模块](https://link.juejin.im/?target=%2Ft196OS%20模块)   | 提供基本的系统操作函数。                                  |
| [Path 模块](https://link.juejin.im/?target=%2Ft200Path%20模块) | 提供了处理和转换文件路的工具。                            |
| [Net 模块](https://link.juejin.im/?target=%2Ft204Net%20模块) | 用于底层的网络通信。提供了服务端和客户端的的操作。        |
| [DNS 模块](https://link.juejin.im/?target=%2Ft214DNS%20模块) | 用于解析域名。                                            |
| [Domain 模块](https://link.juejin.im/?target=%2Ft219Domain%20模块) | 简化异步代码的异常处理，可以捕捉处理try catch无法捕捉的。 |
...
接着我们在浏览器中打开地址：[http://127.0.0.1:8081/index.htm，显示如下图所示](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Findex.htm，显示如下图所示):
...
在浏览器中访问 [http://127.0.0.1:8081，结果如下图所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081，结果如下图所示：)
...
接下来你可以尝试访问 [http://127.0.0.1:8081](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081) 不同的地址，查看效果。

在浏览器中访问 [http://127.0.0.1:8081/list_user，结果如下图所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Flist_user，结果如下图所示：)

![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)

在浏览器中访问 [http://127.0.0.1:8081/abcd，结果如下图所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Fabcd，结果如下图所示：)

![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)

在浏览器中访问 [http://127.0.0.1:8081/abcdefg，结果如下图所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Fabcdefg，结果如下图所示：)
...
让我们再修改下 "Hello Word" 应用添加处理静态文件的功能。 创建 express_demo3.js 文件，代码如下所示：
...
在浏览器中访问 [http://127.0.0.1:8081/images/logo.png（本实例采用了菜鸟教程的logo）。](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Fimages%2Flogo.png（本实例采用了菜鸟教程的logo）。)
...
浏览器访问 [http://127.0.0.1:8081/index.htm，如图所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2Findex.htm，如图所示：)

![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)

现在你可以向表单输入数据，并提交，如下演示：

![img](https://user-gold-cdn.xitu.io/2016/11/29/34f99f623fa4fb49c5c4bc50c8183463?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2016/11/29/c45ceef9233c4fc678710b92e52b09a9?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

现在你可以向表单输入数据，并提交，如下演示：

![img](https://lc-api-gold-cdn.xitu.io/85dcc692c2b0420c7f60.gif?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
现在你可以访问 [http://127.0.0.1:8081](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081) 并查看终端信息的输出，如下演示：
...
Express官网： [expressjs.com/](https://link.juejin.im/?target=http%3A%2F%2Fexpressjs.com%2F)

Express4.x API：[expressjs.com/zh-cn/4x/ap…](https://link.juejin.im/?target=http%3A%2F%2Fexpressjs.com%2Fzh-cn%2F4x%2Fapi.html)
...
RESTful Web 服务通常可以通过自动客户端或代表用户的应用程序访问。但是，这种服务的简便性让用户能够与之直接交互，使用它们的 Web 浏览器构建一个 GET URL 并读取返回的内容。 更多介绍，可以查看：[RESTful 架构详解](https://link.juejin.im/?target=http%3A%2F%2Fwww.runoob.com%2Fw3cnote%2Frestful-architecture.html)
...
在浏览器中访问 [http://127.0.0.1:8081/listUsers，结果如下所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2FlistUsers，结果如下所示：)
...
在浏览器中访问 [http://127.0.0.1:8081/addUser，结果如下所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2FaddUser，结果如下所示：)
...
在浏览器中访问 [http://127.0.0.1:8081/2，结果如下所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2F2，结果如下所示：)
...
在浏览器中访问 [http://127.0.0.1:8081/deleteUser，结果如下所示：](https://link.juejin.im/?target=http%3A%2F%2F127.0.0.1%3A8081%2FdeleteUser，结果如下所示：)
...
for(var i=0; i<3; i++)="" {="" var="" workerprocess="child_process.exec('node" support.js="" '+i,="" function="" (error,="" stdout,="" stderr)="" if="" (error)="" console.log(error.stack);="" console.log('error="" code:="" '+error.code);="" console.log('signal="" received:="" '+error.signal);="" }="" console.log('stdout:="" '="" +="" stdout);="" console.log('stderr:="" stderr);="" });="" workerprocess.on('exit',="" (code)="" console.log('子进程已退出，退出码="" '+code);="" <="" code="">
```
...
for(var i=0; i<3; i++)="" {="" var="" workerprocess="child_process.spawn('node'," ['support.js',="" i]);="" workerprocess.stdout.on('data',="" function="" (data)="" console.log('stdout:="" '="" +="" data);="" });="" workerprocess.stderr.on('data',="" console.log('stderr:="" workerprocess.on('close',="" (code)="" console.log('子进程已退出，退出码="" '+code);="" }="" <="" code="">
```
...
for(var i=0; i<3; i++)="" {="" var="" worker_process="child_process.fork("support.js"," [i]);="" worker_process.on('close',="" function="" (code)="" console.log('子进程已退出，退出码="" '="" +="" code);="" });="" }="" <="" code="">
```
...
下载 JXcore 安装包 [github.com/jxcore/jxco…](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fjxcore%2Fjxcore-release)，你需要根据你自己的系统环境来下载安装包。 1、Window 平台下载：[Download(Windows x64 (V8))](https://link.juejin.im/?target=https%3A%2F%2Fraw.githubusercontent.com%2Fjxcore%2Fjxcore-release%2Fmaster%2F0311%2Fjx_win64v8.zip)。 2、Linux/OSX 安装命令：
...
更多 JXcore 功能特性你可以参考官网：[jxcore.com/](https://link.juejin.im/?target=http%3A%2F%2Fjxcore.com%2F)。

Powered by [idoc](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fjaywcjlove%2Fidoc). Dependence [Node.js](https://link.juejin.im/?target=https%3A%2F%2Fnodejs.org) run.