...
`this.props` 包含了组件该调用者定义的属性。查看 [组件 & Props](http://taro-docs.jd.com/taro/docs/apis/about/props.md) 关于属性的介绍。
...
查看 [生命周期 & State](http://taro-docs.jd.com/taro/docs/apis/about/state.md) 了解更多关于状态的信息。
