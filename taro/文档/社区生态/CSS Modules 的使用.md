...
Taro 中内置了 [CSS Modules](https://github.com/css-modules/css-modules) 的支持，但默认是关闭的，如果需要开启使用，请先在[编译配置](https://taro-docs.jd.com/taro/docs/config-detail.html)中添加如下配置。
...
- `字符串`，其格式见：https://github.com/webpack/loader-utils#interpolatename，值得指出的是，可使用 `[local]` 取其原类名
